...
/**
 * Exporting configuration. Basic but extendable.
 * @type {Object}
 */
var config = {
    processingDir : './.' + '/highcharts_exports' // Default: the same directory of the using module
};
            ...
            svg2png(baseSVGFile, basePNGFile, hcExportRequest.scale, function(err){
                switch(outputFormat){
                    ...
                    default:
                        ...
                        callback({message: errorMessage, origin:'_exportChart'},null);
                }
            });
        }
    });
...
/**
 * Executes an incoming Highcharts request into the requested format
